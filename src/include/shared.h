...
#define _BY_(bits) _B##bits
#define _BY(bits) _BY_(bits)
#define _HEX_(n) 0x##n
#define _HEX(n) _HEX_(n)
#define _CCAT_(a, b) a##b
#define _CCAT(a, b) _CCAT_(a, b)
#define B8(a) _HEX(_BY(a))
#define B16(a, b) _HEX(_CCAT(_BY(a), _BY(b)))
#define B32(a, b, c, d) HEX(_CCAT(_CCAT(_BY(a), _BY(b)), _CCAT(_BY(c), _BY(d))))
